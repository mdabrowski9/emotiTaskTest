 ...
 */
final class Version20220617202055 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE booking ADD date_from DATE NOT NULL');
        $this->addSql('ALTER TABLE booking ADD date_to DATE NOT NULL');
